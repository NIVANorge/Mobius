...
\item Values of {\bf time} type are provided as a date on the format YYYY-MM-DD, potentially followed by a time on the format hh:mm:ss if the model supports sub-daily timesteps.
\end{enumerate}
