...
During model calibration you can also see the changes in each statistic between runs. This is displayed inside a paranthesis after the value of the given statistic.
