...
During model development it can be pretty unsatisfactory to just look at the numbers printed out by {\tt PrintResultSeries} in order to determine if the model performs as expected. It can be a good idea to set up an MobiView (or python wrapper) - compatible model application early. We will not provide an in-depth description of how to do that in this document, but you can look at Tutorial 3 in the Mobius github repository.
