...
\begin{enumerate}[i]
\item Initial value equations have their own evaluation order \emph{inside the solver batc groups of the equations they generate initial values for}. What this means is that if you have two initial value equations where their "parent" equations are in the same batch group, you can let the initial value equations have a different dependency order than the parent equations.
