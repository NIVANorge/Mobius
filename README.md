...
- The 'Applications' folder is where the .cpp files for each model live, as well as the .bat files for compling them. Each model typically loads one or more of the modules that is in the 'Modules' folder.
