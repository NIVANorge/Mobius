...
g++ sedflex_dll.cpp -m64 -o2 -DARMA_DONT_USE_WRAPPER -o sedflex.dll -L"lib_win64" -llibopenblas -s -static -static-libgcc -static-libstdc++ -shared -Wl,--subsystem,windows